...
public class ThirdMarketPreResultConsumer implements RocketMQListener<Request<ThirdMatchPreResultDTO>> {
    ...
    @Override
    public void onMessage(Request<ThirdMatchPreResultDTO> thirdMatchPreResultDTORequest) {
        thirdMarketPreResultProcessor.thirdMarketPreResultApi(thirdMatchPreResultDTORequest);
    }
}
