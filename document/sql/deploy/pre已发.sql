...
-- 最大盘口数,s是否支持串关默认值设置
update  market_category_sell set market_count = 3 ,is_series =1 where sell_status ='Sold' and sell_time >(unix_timestamp(now()) * 1000)- (60 * 60 * 24 * 1000 * 15) ;
...
-- 2.篮球
delete from standard_sport_market_category where sport_id = 2 and market_category_id in (10001,10003,10004);
INSERT INTO standard_sport_market_category (sport_id, market_category_id, name_code, desc_name_code, is_collapse, scope_id, `status`, order_no, create_time, modify_time ) VALUES
