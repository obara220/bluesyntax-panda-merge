...
//        consumerGroup = CONSUME_NONREALTIME_GROUP + DATA_PUSH_DRUID_MESSAGE,
...
//            rocketMqTemplate.send(DATA_DRUID_MESSAGE_HANDLER+":nonrealtime"+linuxLocalIp, builder.build());
//            log.info("linkId=【{}】,topic={},非实时服务数据库监听信息处理结束,data={}", linkId, DATA_DRUID_MESSAGE_HANDLER, data);
//        } catch (Exception e) {
//            log.error("linkId=【"+linkId+"】,非实时服务数据库监听信息异常,Exception:",e);
//        }
//    }
//
...
//            log.error("traceId=【"+traceId+"】,非实时服务数据库监听Druid数据采集异常,Exception:",e);
//        }
//        try {
//            //本地调试校验
...
//            }
//        } catch (Exception e) {
//            log.error("traceId=【"+traceId+"】,非实时服务数据库监听Druid数据采集本地调试校验异常,Exception:",e);
//        }
...
//            log.error("traceId=【"+traceId+"】,非实时服务数据库监听获取节点名称异常,Exception:",e);
//        }
...
//                });
//
//        log.info("traceId=【{}】,非实时服务数据库监听本地调试校验结果,result={}", traceId, JSONObject.toJSONString(result));
//    }
//    // 辅助方法
