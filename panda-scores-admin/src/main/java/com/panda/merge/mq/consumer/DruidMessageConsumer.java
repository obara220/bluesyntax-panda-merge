...
//import static com.panda.merge.constant.ConstantSystem.CONSUME_PANDA_SCORES_ADMIN_GROUP;
...
// *
// * @author warren
// * @since 2025/01/05 14:02:34
// */
//@Slf4j
//@Component
//@RocketMQMessageListener(
//        topic = DATA_PUSH_DRUID_MESSAGE,
//        consumerGroup = CONSUME_PANDA_SCORES_ADMIN_GROUP + DATA_PUSH_DRUID_MESSAGE,
...
//            String linkId = "panda-scores-admin_" + traceId + "_" + linuxLocalIp;
...
//            rocketMqTemplate.send(DATA_DRUID_MESSAGE_HANDLER + ":panda-scores-admin_" + linuxLocalIp, builder.build());
//            log.info("::{}::topic={}比分中心数据库信息处理结束,data={}", linkId, DATA_DRUID_MESSAGE_HANDLER, data);
//        } catch (Exception e) {
//            log.info("比分中心监听数据库信息异常");
//        }
//    }
//
