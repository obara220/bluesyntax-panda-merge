 ...
 */
@Data
public class StandardSportTournamentBO implements Serializable {
    ...
    /** 联赛组别类型(32强:1/16强:2/8强:3/半决赛:4/决赛:5)*/
     ...
     * 自建联赛标识：0:非自建，1：自建
     */
    private Integer tournamentCreateType;
    /**
     * 关联数据源数量
     */
