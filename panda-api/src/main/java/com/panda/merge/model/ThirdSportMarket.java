...
public class ThirdSportMarket implements Serializable {
    ...
    public String getInternalDataSourceCode() {
        return internalDataSourceCode;
    }

    public void setInternalDataSourceCode(String internalDataSourceCode) {
