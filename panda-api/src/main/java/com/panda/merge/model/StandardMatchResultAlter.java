...
public class StandardMatchResultAlter implements Serializable {
    private Long id;
    ...
    @ApiModelProperty(value = "更改赛果事件状态：0：待确认；2：确认；4：拒绝")
    ...
    @ApiModelProperty(value = "审核是否编辑：1未编辑2有编辑")
    ...
    @ApiModelProperty(value = "原事件模板内容")
    private String templateTextOld;

    @ApiModelProperty(value = "事件模板内容EN")
    private String templateTextEn;

    @ApiModelProperty(value = "事件模板内容EN")
    private String templateTextOldEn;

    @ApiModelProperty(value = "球队名称EN")
    ...
    public String getTemplateTextOld() {
        return templateTextOld;
    }

    public void setTemplateTextOld(String templateTextOld) {
        this.templateTextOld = templateTextOld;
    }

    public String getTemplateTextEn() {
        return templateTextEn;
    }

    public void setTemplateTextEn(String templateTextEn) {
        this.templateTextEn = templateTextEn;
    }

    public String getTemplateTextOldEn() {
        return templateTextOldEn;
    }

    public void setTemplateTextOldEn(String templateTextOldEn) {
        this.templateTextOldEn = templateTextOldEn;
    }
    ...
    public String toString() {
        ...
        sb.append(", templateTextOld=").append(templateTextOld);
        sb.append(", templateTextEn=").append(templateTextEn);
        sb.append(", templateTextOldEn=").append(templateTextOldEn);
