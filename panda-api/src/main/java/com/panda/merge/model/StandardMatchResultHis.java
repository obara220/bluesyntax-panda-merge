...
public class StandardMatchResultHis implements Serializable {
    private Long id;
    ...
    @ApiModelProperty(value = "赛果事件状态：0：待确认；1：待自动确认；2：已确认；3：已暂停；4：无效；5：待二次审核中；6：二次拒绝；7：互斥")
    ...
    @ApiModelProperty(value = "总盘口数")
    private Integer totalMarketNum;

    @ApiModelProperty(value = "事件可信度等级")
    ...
    public Integer getPtMonth() {
        return ptMonth;
    }

    public void setPtMonth(Integer ptMonth) {
    ...
    public Integer getTotalMarketNum() {
        return totalMarketNum;
    }

    public void setTotalMarketNum(Integer totalMarketNum) {
        this.totalMarketNum = totalMarketNum;
    }
    ...
    public String toString() {
        ...
        sb.append(", ptMonth=").append(ptMonth);
        ...
        sb.append(", totalMarketNum=").append(totalMarketNum);
