...
public class MatchScoresEventInfo implements Serializable {
    ...
    @ApiModelProperty(value = "附加字段")
    private String addition7;      //用于帮忙前端区分eventInfo展示 0:保持原样 1：增加一  -1：减一
    ...
    @ApiModelProperty(value = "赛事控制类型:1 开始   2 暂停  3 继续  4 结束")
