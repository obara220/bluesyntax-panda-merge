...
public class ConfigOutrightTradeOdds implements Serializable {
    private Long id;
    ...
    public Integer getOddsStatus() {
        return oddsStatus;
    }

    public void setOddsStatus(Integer oddsStatus) {
    ...
    public String toString() {
        ...
        sb.append(", oddsStatus=").append(oddsStatus);
