...
public class MatchResultLog implements Serializable {
    private Long id;

    @ApiModelProperty(value = "运动ID")
    private Long sportId;

    @ApiModelProperty(value = "标准赛果ID")
    private Long standardMatchResultId;
    ...
    @ApiModelProperty(value = "启动自动确认的时间戳")
    ...
    public Long getStandardMatchResultId() {
        return standardMatchResultId;
    }

    public void setStandardMatchResultId(Long standardMatchResultId) {
        this.standardMatchResultId = standardMatchResultId;
    }
    ...
    public String toString() {
        ...
        sb.append(", standardMatchResultId=").append(standardMatchResultId);
