...
public class ConfigMarketCategoryHead implements Serializable {
    private Long id;
    ...
    public Double getMarketHeadGap() {
        return marketHeadGap;
    }

    public void setMarketHeadGap(Double marketHeadGap) {
    ...
    public Double getMarketHeadGapInitial() {
        return marketHeadGapInitial;
    }

    public void setMarketHeadGapInitial(Double marketHeadGapInitial) {
        this.marketHeadGapInitial = marketHeadGapInitial;
    }
    ...
    public String toString() {
        ...
        sb.append(", marketHeadGap=").append(marketHeadGap);
        ...
        sb.append(", marketHeadGapInitial=").append(marketHeadGapInitial);
