...
public class StandardSportMarketOdds implements Serializable, StandardMarketOddsModification {
    ...
    public Double getMarketDiffValue() {
        return marketDiffValue;
    }

    public void setMarketDiffValue(Double marketDiffValue) {
        this.marketDiffValue = marketDiffValue;
    }

    public List<I18nItemDTO> getI18nNames() {
        return i18nNames;
    }

    public void setI18nNames(List<I18nItemDTO> i18nNames) {
