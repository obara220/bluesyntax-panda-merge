...
public class MatchSettleScore implements Serializable {
    private Long id;
    ...
    public Integer getScoreCheckTag() {
        return scoreCheckTag;
    }

    public void setScoreCheckTag(Integer scoreCheckTag) {
        this.scoreCheckTag = scoreCheckTag;
    }
    public String getPopupUsers() {
        return popupUsers;
    }

    public void setPopupUsers(String popupUsers) {
    ...
    public String toString() {
        ...
        sb.append(", popupUsers=").append(popupUsers);
        sb.append(", scoreCheckTag=").append(scoreCheckTag);
