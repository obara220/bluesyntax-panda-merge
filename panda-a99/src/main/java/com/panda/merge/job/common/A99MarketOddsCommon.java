                        ...
                        if (CollectionUtil.isNotEmpty(matchMarketList) || CollectionUtil.isNotEmpty(closesMarketList)) {
                            ...
                            if (CollectionUtil.isNotEmpty(matchMarketList)) {
                                ...
                                for (ThirdSportMarketMessage market : matchMarketList) {
                                    ...
                                    double rev1 = NumberUtil.div(Double.valueOf("100000"), Double.valueOf(odds1.getOddsValue()));
                                    double rev2 = NumberUtil.div(Double.valueOf("100000"), Double.valueOf(odds2.getOddsValue()));
                                    //最后用两个投注项的倒数相乘，得到坑位值
...
//                            }
                ...
                if (CollectionUtil.isNotEmpty(mainMarketList)) {
