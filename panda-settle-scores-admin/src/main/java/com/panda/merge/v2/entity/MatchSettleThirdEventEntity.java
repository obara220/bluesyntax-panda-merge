...
@Data
@TableName("match_settle_third_event")
public class MatchSettleThirdEventEntity implements Serializable {
    private static final long serialVersionUID = 7521997073451014817L;
    ...
    @ApiModelProperty(value = "距离比赛开始秒数")
