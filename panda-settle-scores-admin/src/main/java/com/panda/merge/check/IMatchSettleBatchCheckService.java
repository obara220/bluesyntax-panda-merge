...
//
//    void batchCheckCommonMatchSettleScoreEvent(List<Pair<Object, MatchSettleCheckInfo>> checkMessages, boolean createCheck, String linkedId, MatchSettleTemplate downTemplate);
//
//    /**
//     * 新增赛事限制操作用户群
//     * */
...
//
//    boolean isMatchGoalStatusConfirm(MatchSettleGoalStatus goalStatus, String eventCode);
//
//
...
//
//    void validateDataScoreMismatch(List<Pair<MatchSettleCheckInfo,MatchSettleThirdScore>> insertCheckInfos, String linkedId);
//
